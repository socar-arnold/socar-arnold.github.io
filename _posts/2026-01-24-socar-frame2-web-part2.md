...
이 글은 **쏘카 디자인 시스템 2.0** 개발기 2편으로, **컴포넌트 아키텍처/패키지 전략/LLM(Large Language Model) 활용**에 집중합니다.
1편에서는 시스템 설계, Figma 연동, 운영 프로세스를 다뤘고, 이번 글에서는 기술적 선택과 구현 경험을 중심으로 정리했습니다.
...
그래서 이 부분은 단발성으로 끝나는 작업이 아니라, 사례를 계속 쌓고 Instructions와 Figma 설계 규칙을 지속적으로 보완해 나가야 하는 영역이라고 봤습니다.
...
관심 있으신 분들의 참고를 위해 [공식문서](https://socarframe.socar.kr/)를 공유드립니다.
